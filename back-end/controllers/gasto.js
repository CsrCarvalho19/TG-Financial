...
controller.listar = async (req, res) => {
    try {
        let dados = await Gasto.find() // Traz todos os gastos cadastrados
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Gasto.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Gasto.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Gasto.findByIdAndDelete(id)
